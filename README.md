...
Find the .sof and .rbf bitstream binaries under their category (arcades, computer, consoles).
...
export PATH="/home/somhic/bin/intelFPGA_lite/17.1/quartus/bin:$PATH"
quartus_pgm --mode=jtag -o "p;core.sof"
